(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactNavbar"] = factory(require("React"));
	else
		root["ReactNavbar"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactNavbar = __webpack_require__(1);

	var _ReactNavbar2 = _interopRequireDefault(_ReactNavbar);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _ReactNavbar2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactNavbar = function (_React$Component) {
		_inherits(ReactNavbar, _React$Component);

		function ReactNavbar(props) {
			_classCallCheck(this, ReactNavbar);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ReactNavbar).call(this, props));

			_this.setInitialState(props);
			_this.rightClicked = _this.rightClicked.bind(_this);
			_this.leftClicked = _this.leftClicked.bind(_this);
			return _this;
		}

		_createClass(ReactNavbar, [{
			key: 'getCurrent',
			...
			value: function push(component) {
				...
				var animation = arguments.length <= 2 || arguments[2] === undefined ? ReactNavbar.Animations.push : arguments[2];

				this.state.stack.push({ component: component, title: title });
				this.setState({
			...
			key: 'pop',
			value: function pop() {
				var animation = arguments.length <= 0 || arguments[0] === undefined ? ReactNavbar.Animations.pop : arguments[0];
			...
			key: 'leftClicked',
			value: function leftClicked() {
				this.pop();
			}
		}, {
			key: 'rightClicked',
			value: function rightClicked() {
				// no default action
			}
		}, {
			key: 'renderLeftItem',
			value: function renderLeftItem() {
				return this.getCurrent().leftItem || _react2.default.createElement(
					'button',
			...
			key: 'renderMiddleItem',
			value: function renderMiddleItem() {
				return this.getCurrent().middleItem || _react2.default.createElement(
					'span',
					null,
			...
			key: 'renderRightItem',
			value: function renderRightItem() {
				return this.getCurrent().rightItem || _react2.default.createElement(
					'button',
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'reactNavbar' },
					_react2.default.createElement(
						'div',
						{ className: 'reactNavbar-container' },
						_react2.default.createElement(
							'div',
							{ className: 'reactNavbar-left' },
							this.renderLeftItem()
						),
						_react2.default.createElement(
							'div',
							{ className: 'reactNavbar-middle' },
							this.renderMiddleItem()
						),
						_react2.default.createElement(
							'div',
							{ className: 'reactNavbar-right' },
	...
	ReactNavbar.propTypes = {
		root: _react.PropTypes.func.isRequired,
		title: _react.PropTypes.string
	};
	ReactNavbar.Animations = {
		push: 'push',
		pop: 'pop'
	};
	exports.default = ReactNavbar;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroupChild = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var ReactTransitionChildMapping = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flattenChildren = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* general styles */\n.reactNavbar-container {\n  height: 50px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: solid 1px #dedede; }\n\n/* animations */\n/* pop animation */\n.reactNavbar-transition-pop-enter {\n  position: absolute;\n  z-index: 1;\n  opacity: 0.8;\n  transform: translateX(-30px); }\n\n.reactNavbar-transition-pop-enter.reactNavbar-transition-pop-enter-active {\n  transform: translateX(0px);\n  opacity: 1;\n  transition: all 400ms cubic-bezier(0, 0.14, 0, 0.94); }\n\n.reactNavbar-transition-pop-leave {\n  position: absolute;\n  z-index: 10;\n  transform: translateX(0px);\n  box-shadow: 0px 0px 1px -3px rgba(0, 0, 0, 0.75); }\n\n.reactNavbar-transition-pop-leave.reactNavbar-transition-pop-leave-active {\n  transform: translateX(100%);\n  box-shadow: -5px 0px 2px -3px rgba(0, 0, 0, 0.75);\n  transition: all 400ms cubic-bezier(0, 0.14, 0, 0.94); }\n\n/* push animation */\n.reactNavbar-transition-push-enter {\n  position: absolute;\n  z-index: 10;\n  opacity: 0.8;\n  box-shadow: -5px 0px 2px -3px rgba(0, 0, 0, 0.75);\n  transform: translateX(100%); }\n\n.reactNavbar-transition-push-enter.reactNavbar-transition-push-enter-active {\n  transform: translateX(0px);\n  opacity: 1;\n  box-shadow: 0px 0px 1px -3px rgba(0, 0, 0, 0.75);\n  transition: all 400ms cubic-bezier(0, 0.14, 0, 0.94); }\n\n.reactNavbar-transition-push-leave {\n  position: absolute;\n  z-index: 1;\n  transform: translateX(0%); }\n\n.reactNavbar-transition-push-leave.reactNavbar-transition-push-leave-active {\n  transform: translateX(-100%);\n  transition: all 400ms cubic-bezier(0, 0.14, 0, 0.94); }\n", ""]);
